...
print('7//2 = ',7//2)
print('#c005--------------------------------------------------')
print('True xor False = True^False =',True^False)
print('#b006--------------------------------------------------')
z = float("nan")
if z==z:
   print('True')
...
print("a,b,c".split(","))
print('#b042--------------------------------------------------')
print('DEF(int())= fload/bool/clean string')
print('int(None) raises TypeError')
print('#b043--------------------------------------------------')
print('int(None) raises TypeError')
print('2ndxy = 3 raises invalid type literal')
print('#b047--------------------------------------------------')
import math
print('val = 21.0375')
val = 21.0375
mantissa, exponent = math.frexp(val)
print(f"Mantissa: {mantissa}")  # Outputs: 0.657421875
print(f"Exponent: {exponent}")  # Outputs: 5
print('#b062--------------------------------------------------')
...
print('#c156-------------------------------------------------')
eing = ["ab 1X2","cdX3 4","ef 5X6"]
print(eing)
print([item.replace("X", "") for item in eing])
print([item.replace("", "X") for item in eing])
print([place.replace("X", "") for place in eing])
print([slice.replace("X", "") for slice in eing])
print('#c157-------------------------------------------------')
eing = ["abX","3X4","X5X"]
print(eing)
print('a',[item.replace("X", "") for item in eing])
print('b',[item.replace("", "X") for item in eing])
print('c',[place.replace("X", "") for place in eing])
print('d',[slice.replace("X", "") for slice in eing])
print('#c158-------------------------------------------------')
eing = ["cd 3 4","ef 5 6"]
print(eing)
print('a',[slice.replace(" ", "") for slice in eing])
print('b',[place.replace(" ", "") for place in eing])
print('c',[item.replace(" ", "") for item in eing])
print('d',[item.replace("", " ") for item in eing])
print('#c159-------------------------------------------------')
eing = ["ab 1 2","cd 3 4"]
print(eing)
print('a',[item.replace(" ", "") for item in eing])
print('b',[slice.replace(" ", "") for slice in eing])
print('c',[item.replace("", " ") for item in eing])
print('d',[place.replace(" ", "") for place in eing])
print('#c160-------------------------------------------------')
eing = ["abX1 2","efX5X6"]
print(eing)
print('a',[item.replace(" ", "X") for item in eing])
print('b',[item.replace("X", " ") for item in eing])
print('c',[slice.replace("X", " ") for slice in eing])
print('d',[place.replace("X", " ") for place in eing])
